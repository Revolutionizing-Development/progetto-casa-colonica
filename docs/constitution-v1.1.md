...
| N6 | No rendering without a renovation plan. | AI renderings must reflect the actual renovation scope the user has configured, not a generic "restored farmhouse." |
